...
Things I've built and shipped, zero to one.
...
**Link:** [joinvault.app](https://joinvault.app)
...
**Link:** [youtube.com/watch?v=UQcJUsA9tSs](https://www.youtube.com/watch?v=UQcJUsA9tSs)
...
Real Estate: led a team of 7 building data-driven Zillow valuations with NLTK and sentiment analysis. EdTech: surfaced a 20% revenue-uplift opportunity across 7,000+ users.

---

### ACM AI - Cassava Leaf Disease Detection

**Period:** Jan 2023 – Mar 2023
**Tech:** PyTorch, CNNs, Transfer learning
**Link:** (no public link)

PyTorch CNNs and transfer learning for crop-disease detection.
...
**Link:** [bit.ly/driverai](https://bit.ly/driverai)

Computer-vision CNN classifying driver attentiveness.
...
**Period:** 2020
**Tech:** Keras, TensorFlow
**Link:** [bit.ly/medicalimagingai](https://bit.ly/medicalimagingai)

CNN reading lung X-rays to flag pneumonia.
